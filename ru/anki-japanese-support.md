...
<img src="../blog/img/鳥でも分かる.webp" float="right">
...
<video width="1032" autoplay loop controls muted>
	<source src="../blog/vid/ajt_japanese_generate.mp4" type="video/mp4">
...
<img float="right" src="../blog/img/ajt-japanese-furigana-display.webp">
...
<p align="center"><img src="../blog/img/ajt-japanese-svg-opts.webp" alt="SVG output format"/></p>
<p align="center"><i>SVG output format.</i></p>

<p align="center"><img src="../blog/img/ajt-japanese-svg-appearance.webp" alt="change SVG appearance"/></p>
...
<p align="center"><img src="../blog/img/ajt-japanese-pitch-html-style.webp" alt="change HTML style"/></p>
...
<p align="center"><img src="../blog/img/ajt-japanese-pitch_accent_on_hover.webp" alt="color coded words"/></p>
...
<p align="center"><img src="../blog/img/ajt-japanese-color-code-pitch.webp" alt="settings"/></p>
...
<p align="center"><img src="../blog/img/ajt-japanese-add-online-source.webp" alt="add online source"/></p>
...
1) NHK accent dictionary, 2016.
   ```
   https://github.com/Ajatt-Tools/nhk_2016_pronunciations_index/releases/latest/download/NHK-2016_main.zip
   ```
1) NHK accent dictionary, 1998.
   ```
   https://github.com/Ajatt-Tools/nhk_1998_pronunciations_index/releases/latest/download/NHK-1998_main.zip
   ```
1) Shinmeikai 8th edition.
   ```
   https://github.com/Ajatt-Tools/shinmeikai_8_pronunciations_index/releases/latest/download/Shinmeikai-8_main.zip
   ```
1) Daijisen.
   ```
   https://github.com/Ajatt-Tools/daijisen_pronunciations_index/releases/latest/download/Daijisen_main.zip
   ```
1) TAAS.
   ```
...
1) NHK accent dictionary, 2016.
   ```
   https://github.com/Ajatt-Tools/nhk_2016_pronunciations_index_mp3/releases/latest//download/NHK-2016_main.zip
   ```
1) NHK accent dictionary, 1998
   ```
   https://github.com/Ajatt-Tools/nhk_1998_pronunciations_index_mp3/releases/latest/download/NHK-1998_main.zip
   ```
1) Shinmeikai 8th edition
   ```
...
<p align="center"><img src="../blog/img/ajt-japanese-add-local-source.webp" alt="add local source"/></p>
...
<p align="center"><img alt="search dialog" src="../blog/img/search_audio_dialog.webp"></p>
...
[Watch a demonstration on ![YouTube](../blog/img/youtube_logo.webp)](https://redirect.invidious.io/watch?v=9e7CkXSdYok).
...
<p align="center"><img src="../blog/img/ajt-japanese-overrides.webp" alt="pitch overrides"/></p>
