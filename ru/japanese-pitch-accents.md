...
<p align="center"><img alt="screenshot" src="../blog/img/goldendict-lookup-人生.webp"></p>
<p align="center"><i>Look up 人生 in スーパー大辞林</i></p>
<p align="center"><img alt="screenshot" src="../blog/img/goldendict-lookup-生活.webp"></p>
...
<p align="center"><img src="../blog/img/goldendict-lookup-ちょっと.webp" alt="screenshot"></p>
...
1) 気 (spirit; mind).
   * In isolation: <span class="heiban"><span class="LH">き</span></span>
     <audio controls>
     <source src="../blog/aud/ki-spirit.ogg" type="audio/ogg" />
   ...
   * With a particle: <span class="heiban"><span class="LH">き</span></span><span class="H">が</span>
     <audio controls>
     <source src="../blog/aud/kiga-spirit.ogg" type="audio/ogg" />
...
1) 国 (country).
   * In isolation: <span class="heiban"><span class="LH">く</span><span class="H">に</span></span>
     <audio controls>
     <source src="../blog/aud/kuni.ogg" type="audio/ogg" />
   ...
   * With a particle: <span class="heiban"><span class="LH">く</span><span class="H">に</span></span><span class="H">が</span>
     <audio controls>
     <source src="../blog/aud/kuniga.ogg" type="audio/ogg" />
...
1) 時間 (time).
   * In isolation: <span class="heiban"><span class="LH">じ</span><span class="H">かん</span></span>
     <audio controls>
     <source src="../blog/aud/jikan.ogg" type="audio/ogg" />
   ...
   * With a particle: <span class="heiban"><span class="LH">じ</span><span class="H">かん</span></span><span class="H">が</span>
     <audio controls>
     <source src="../blog/aud/jikanga.ogg" type="audio/ogg" />
...
1) 何時 (いつ, when).
   * In isolation: <span class="atamadaka"><span class="HL">い</span><span class="L">つ</span></span>
     <audio controls>
     <source src="../blog/aud/itsu.ogg" type="audio/ogg" />
   ...
   * With a particle: <span class="atamadaka"><span class="HL">い</span><span class="L">つ</span></span><span class="L">が</span>
     <audio controls>
     <source src="../blog/aud/itsuga.ogg" type="audio/ogg" />
...
1) 天気 (weather).
   * In isolation: <span class="atamadaka"><span class="HL">て</span><span class="L">んき</span></span>
     <audio controls>
     <source src="../blog/aud/tenki.ogg" type="audio/ogg" />
   ...
   * With a particle: <span class="atamadaka"><span class="HL">て</span><span class="L">んき</span></span><span class="L">が</span>
     <audio controls>
     <source src="../blog/aud/tenkiga.ogg" type="audio/ogg" />
...
1) 毎日 (every day).
   * In isolation: <span class="atamadaka"><span class="HL">ま</span><span class="L">いにち</span></span>
     <audio controls>
     <source src="../blog/aud/mainichi.ogg" type="audio/ogg" />
   ...
   * With a particle: <span class="atamadaka"><span class="HL">ま</span><span class="L">いにち</span></span><span class="L">が</span>
     <audio controls>
     <source src="../blog/aud/mainichiga.ogg" type="audio/ogg" />
...
1) 一つ (one). Accent: 2.
   * In isolation: <span class="nakadaka"><span class="LH">ひ</span><span class="HL">と</span><span class="L">つ</span></span>
     <audio controls>
     <source src="../blog/aud/hitotsu.ogg" type="audio/ogg" />
   ...
   * With a particle: <span class="nakadaka"><span class="LH">ひ</span><span class="HL">と</span><span class="L">つ</span></span><span class="L">が</span>
     <audio controls>
     <source src="../blog/aud/hitotsuga.ogg" type="audio/ogg" />
...
1) スポーツ (sports). Accent: 2.
   * In isolation: <span class="nakadaka"><span class="LH">ス</span><span class="HL">ポ</span><span class="L">ーツ</span></span>
     <audio controls>
     <source src="../blog/aud/supootsu.ogg" type="audio/ogg" />
   ...
   * With a particle: <span class="nakadaka"><span class="LH">ス</span><span class="HL">ポ</span><span class="L">ーツ</span></span><span class="L">が</span>
     <audio controls>
     <source src="../blog/aud/supootsuga.ogg" type="audio/ogg" />
...
1) 工場 (factory). Accent: 3.
   * In isolation: <span class="nakadaka"><span class="LH">こ</span><span class="HL">うじょ</span><span class="L">う</span></span>
     <audio controls>
     <source src="../blog/aud/koujou.ogg" type="audio/ogg" />
   ...
   * With a particle: <span class="nakadaka"><span class="LH">こ</span><span class="HL">うじょ</span><span class="L">う</span></span><span class="L">が</span>
     <audio controls>
     <source src="../blog/aud/koujouga.ogg" type="audio/ogg" />
...
1) 木 (tree). Accent: 1.
   * In isolation: <span class="odaka"><span class="HL">き</span></span>
     <audio controls>
     <source src="../blog/aud/ki-tree.ogg" type="audio/ogg" />
   ...
   * With a particle: <span class="odaka"><span class="HL">き</span></span><span class="L">が</span>
     <audio controls>
     <source src="../blog/aud/kiga-tree.ogg" type="audio/ogg" />
...
1) 川 (river). Accent: 2.
   * In isolation: <span class="odaka"><span class="LH">か</span><span class="HL">わ</span></span>
     <audio controls>
     <source src="../blog/aud/kawa.ogg" type="audio/ogg" />
   ...
   * With a particle: <span class="odaka"><span class="LH">か</span><span class="HL">わ</span></span><span class="L">が</span>
     <audio controls>
     <source src="../blog/aud/kawaga.ogg" type="audio/ogg" />
...
1) 二つ (two). Accent: 3.
   * In isolation: <span class="odaka"><span class="LH">ふ</span><span class="HL">たつ</span></span>
     <audio controls>
     <source src="../blog/aud/futatsu.ogg" type="audio/ogg" />
   ...
   * With a particle: <span class="odaka"><span class="LH">ふ</span><span class="HL">たつ</span></span><span class="L">が</span>
     <audio controls>
     <source src="../blog/aud/futatsuga.ogg" type="audio/ogg" />
...
* お母さん (mother).
  ...
  <audio controls>
  <source src="../blog/aud/okaasan.ogg" type="audio/ogg" />
...
* お巡さん (policeman).
  ...
  <audio controls>
  <source src="../blog/aud/omawarisan.ogg" type="audio/ogg" />
...
1) ひ.
   * 日 (day). Accent: 0.
     ...
     <audio controls>
     <source src="../blog/aud/hi-day.ogg" type="audio/ogg" />
   ...
   * 火 (fire). Accent: 1.
     ...
     <audio controls>
     <source src="../blog/aud/hi-fire.ogg" type="audio/ogg" />
...
1) いち.
   * 一 (one). Accent: 2.
     ...
     <audio controls>
     <source src="../blog/aud/ichiga-one.ogg" type="audio/ogg" />
   ...
   * 位置 (position). Accent: 1.
     ...
     <audio controls>
     <source src="../blog/aud/ichiwo-position.ogg" type="audio/ogg" />
...
1) かみ.
   * 紙 (paper). Accent: 2.
     ...
     <audio controls>
     <source src="../blog/aud/kamiga-paper-hair.ogg" type="audio/ogg" />
   ...
   * 神 (god). Accent: 1.
     ...
     <audio controls>
     <source src="../blog/aud/kamiwo-god.ogg" type="audio/ogg" />
...
1) はな.
   * 花 (flower). Accent: 2.
     ...
     <audio controls>
     <source src="../blog/aud/hanawo-flower.ogg" type="audio/ogg" />
   ...
   * 鼻 (nose). Accent: 0.
     ...
     <audio controls>
     <source src="../blog/aud/hanawo-nose.ogg" type="audio/ogg" />
...
1) あさ.
   * 朝 (morning). Accent: 1.
     ...
     <audio controls>
     <source src="../blog/aud/asawo-morning.ogg" type="audio/ogg" />
   ...
   * 麻 (cannabis, flax). Accent: 2.
     ...
     <audio controls>
     <source src="../blog/aud/asawo-cannabis.ogg" type="audio/ogg" />
...
1) ようい.
   * 用意 (use). Accent: 1.
     ...
     <audio controls>
     <source src="../blog/aud/youi-use.ogg" type="audio/ogg" />
   ...
   * 容易 (ease). Accent: 0.
     ...
     <audio controls>
     <source src="../blog/aud/youi-ease.ogg" type="audio/ogg" />
...
1) おもい.
   * 重い (heavy). Accent: 0.
     ...
     <audio controls>
     <source src="../blog/aud/omoi-heavy.ogg" type="audio/ogg" />
   ...
   * 思い (thought). Accent: 2.
     ...
     <audio controls>
     <source src="../blog/aud/omoi-thought.ogg" type="audio/ogg" />
...
1) かう.
   * 買う (to buy). Accent: 0.
     ...
     <audio controls>
     <source src="../blog/aud/kau-to-buy.ogg" type="audio/ogg" />
   ...
   * 飼う (to have a pet). Accent: 1.
     ...
     <audio controls>
     <source src="../blog/aud/kau-to-own.ogg" type="audio/ogg" />
...
1) はし.
   * 橋 (bridge). Accent: 2.
     ...
     <audio controls>
     <source src="../blog/aud/hashiwo-bridge.ogg" type="audio/ogg" />
   ...
   * 端 (edge). Accent: 0.
     ...
     <audio controls>
     <source src="../blog/aud/hashiwo-edge.ogg" type="audio/ogg" />
   ...
   * 箸 (chopsticks). Accent: 1.
     ...
     <audio controls>
     <source src="../blog/aud/hashiwo-chopsticks.ogg" type="audio/ogg" />
...
1) かた.
   * 肩 (shoulder). Accent: 1.
     ...
     <audio controls>
     <source src="../blog/aud/katawo-shoulder.ogg" type="audio/ogg" />
   ...
   * 型 (type). Accent: 2.
     ...
     <audio controls>
     <source src="../blog/aud/katawo-type-person.ogg" type="audio/ogg" />
...
* 会社 (company). Accent: 0.
  ...
  <audio controls>
  <source src="../blog/aud/kaishaga-company.ogg" type="audio/ogg" />
...
* 世界 (world). Accent: 1.
  ...
  <audio controls>
  <source src="../blog/aud/sekaiga-world.ogg" type="audio/ogg" />
...
* 日本 (Japan). Accent: 2.
  ...
  <audio controls>
  <source src="../blog/aud/nihonga-japan.ogg" type="audio/ogg" />
...
* 言葉 (word). Accent: 3.
  ...
  <audio controls>
  <source src="../blog/aud/kotobaga-word.ogg" type="audio/ogg" />
...
1) ません. Drop after せ.
   ...
   * 食べる. Accent: 2.
     <span class="LH">た</span><span class="HL">べませ</span><span class="L">ん</span>
...
1) Plain. 言う (say).
   ...
   <audio controls>
   <source src="../blog/aud/iu-say.ogg" type="audio/ogg" />
...
1) Plain negative. 言わない (does not say).
   ...
   <audio controls>
   <source src="../blog/aud/iwanai-doesntsay.ogg" type="audio/ogg" />
...
1) Past. 言った (said).
   ...
   <audio controls>
   <source src="../blog/aud/itta-said.ogg" type="audio/ogg" />
...
1) "Te form". 言って (saying).
   ...
   <audio controls>
   <source src="../blog/aud/itte-saying.ogg" type="audio/ogg" />
...
1) Potential. 言える (can say).
   ...
   <audio controls>
   <source src="../blog/aud/ieru-cansay.ogg" type="audio/ogg" />
...
1) Passive. 言われる (is said).
   ...
   <audio controls>
   <source src="../blog/aud/iwareru-issaid.ogg" type="audio/ogg" />
...
1) Causative. 言わせる (make say).
   ...
   <audio controls>
   <source src="../blog/aud/iwaseru-makesay.ogg" type="audio/ogg" />
...
1) Past negative. 言わなかった (did not say).
   ...
   <audio controls>
   <source src="../blog/aud/iwanakatta-didnotsay.ogg" type="audio/ogg" />
...
1) Conditional. 言えば (if I say).
   ...
   <audio controls>
   <source src="../blog/aud/ieba-ifisay.ogg" type="audio/ogg" />
...
1) Volitional. 言おう (want to say).
   ...
   <audio controls>
   <source src="../blog/aud/iou-wanttosay.ogg" type="audio/ogg" />
...
1) Plain. 見る (see).
   ...
   <audio controls>
   <source src="../blog/aud/miru-see.ogg" type="audio/ogg" />
...
1) Past. 見た (saw).
   ...
   <audio controls>
   <source src="../blog/aud/mita-saw.ogg" type="audio/ogg" />
...
1) Te. 見て (seeing).
   ...
   <audio controls>
   <source src="../blog/aud/mite-seeing.ogg" type="audio/ogg" />
...
1) Conditional. 見れば (if I see).
   ...
   <audio controls>
   <source src="../blog/aud/mireba-ifisee.ogg" type="audio/ogg" />
...
1) Plain. 食べる (eat).
   ...
   <audio controls>
   <source src="../blog/aud/taberu-eat.ogg" type="audio/ogg" />
...
1) Past. 食べた (ate).
   ...
   <audio controls>
   <source src="../blog/aud/tabeta-ate.ogg" type="audio/ogg" />
...
1) Te. 食べて (eating).
   ...
   <audio controls>
   <source src="../blog/aud/tabete-eating.ogg" type="audio/ogg" />
...
1) Conditional. 食べれば (if I eat).
   ...
   <audio controls>
   <source src="../blog/aud/tabereba-ifieat.ogg" type="audio/ogg" />
...
1) Plain negative. 見ない (doesn't see).
   ...
   <audio controls>
   <source src="../blog/aud/minai-doesntsee.ogg" type="audio/ogg" />
...
1) Past negative. 見なかった (didn't see).
   ...
   <audio controls>
   <source src="../blog/aud/minakatta-didntsee.ogg" type="audio/ogg" />
...
1) Potential / passive. 見られる (is seen / be able to see).
   ...
   <audio controls>
   <source src="../blog/aud/mirareru-isseen.ogg" type="audio/ogg" />
...
1) Causative. 見させる (make see).
   ...
   <audio controls>
   <source src="../blog/aud/misaseru-makesee.ogg" type="audio/ogg" />
...
1) -nagara. 見ながら (while seeing).
   ...
   <audio controls>
   <source src="../blog/aud/minagara-whileseeing.ogg" type="audio/ogg" />
...
1) Plain. 暑い (hot).
   ...
   <audio controls>
   <source src="../blog/aud/atsui-hot.ogg" type="audio/ogg" />
...
1) Past. 暑かった (was hot).
   ...
   <audio controls>
   <source src="../blog/aud/atsukatta-washot.ogg" type="audio/ogg" />
...
1) Te. 暑くて (hot...).
   ...
   <audio controls>
   <source src="../blog/aud/atsukute-hot.ogg" type="audio/ogg" />
...
1) Plain. 暑くない (not hot).
   ...
   <audio controls>
   <source src="../blog/aud/atsukunai-nothot.ogg" type="audio/ogg" />
...
1) Past. 暑くなかった (was not hot).
   ...
   <audio controls>
   <source src="../blog/aud/atsukunakatta-wasnothot.ogg" type="audio/ogg" />
...
1) 静か (quiet). Accent: 1.
   ...
   <audio controls>
   <source src="../blog/aud/shizuka-quiet.ogg" type="audio/ogg" />
...
1) 安全 (safe). Accent: 0.
   ...
   <audio controls>
   <source src="../blog/aud/anzen-safe.ogg" type="audio/ogg" />
...
1) 賑やか (lively). Accent: 2.
   ...
   <audio controls>
   <source src="../blog/aud/nigiyaka-lively.ogg" type="audio/ogg" />
...
1) Plain. 静かではない (not quiet).
   ...
   <audio controls>
   <source src="../blog/aud/shizukadehanai-notquiet.ogg" type="audio/ogg" />
...
1) Past. 静かではなかった (was not quiet).
   ...
   <audio controls>
   <source src="../blog/aud/shizukadehanaatta-wasnotquiet.ogg" type="audio/ogg" />
...
1) 秋です (is autumn, it is autumn).
   ...
   <audio controls>
   <source src="../blog/aud/akidesu-isautumn.ogg" type="audio/ogg" />
...
1) 学生です (is a student, I'm a student).
   ...
   <audio controls>
   <source src="../blog/aud/gakuseedesu-isastudent.ogg" type="audio/ogg" />
...
<audio controls>
<source src="../blog/aud/watashiha-nihongowo-benkyoo-shite-imasu.ogg" type="audio/ogg" />
...
<audio controls>
<source src="../blog/aud/watashihanihongowobenkyooshiteimasu.ogg" type="audio/ogg" />
...
<span class="nakadaka"><span class="LH">い</span><span class="HL">ま</span><span class="L">す</span></span>
<audio controls>
<source src="../blog/aud/bokuha-senseiwo-shite-imasu.ogg" type="audio/ogg" />
...
<img alt="僕は先生をしています gradual" src="../blog/img/bokuhasenseiwoshiteimasu-gradual.webp">

<audio controls>
<source src="../blog/aud/bokuhasenseiwoshiteimasu_gradual.ogg" type="audio/ogg" />
...
<img alt="僕は先生をしています emphasis" src="../blog/img/bokuhasenseiwoshiteimasu_emphasis.webp">

<audio controls>
<source src="../blog/aud/bokuhasenseiwoshiteimasu_emphasis.ogg" type="audio/ogg" />
...
1) 日本 (Japan). Accent: 2.
   ...
   <audio controls>
   <source src="../blog/aud/nihon-japan.ogg" type="audio/ogg" />
...
1) 日本語 (Japanese language). Accent: 0.
   ...
   <audio controls>
   <source src="../blog/aud/nihongo-japaneselang.ogg" type="audio/ogg" />
...
1) 日本人 (Japanese person). Accent: 4.
   ...
   <audio controls>
   <source src="../blog/aud/nihonjin-japaneseperson.ogg" type="audio/ogg" />
...
1) 日本海 (Japan Sea). Accent: 2.
   ...
   <audio controls>
   <source src="../blog/aud/nihonkai-japansea.ogg" type="audio/ogg" />
