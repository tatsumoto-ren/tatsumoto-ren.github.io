...
pitch accent information and an image or a snapshot of the scene.
...
The algorithm is
[explained](http://www.alljapaneseallthetime.com/blog/10000-sentences-how/)
on the AJATT site.
...
### Are sentence cards worth it

Sentence cards probably stand the closest to the ideal card template.
...
2) Recall the meaning of the word.
...
You can find this card template in most popular
[Core decks](http://rtkwiki.koohii.com/wiki/Core_10k).
Core decks aren't very popular anymore once the
[Tango decks](https://t.me/ajatt_tools/28)
became available,
but the card template ripped from them has been used by some people in the community.

WCCs have been referred to under a dozen of different names,
most of them are extremely misleading. For example:
* Anime cards: but you can make them not just from anime.
* Audio cards: then they should have audio on the front of the card, but they have it on the back.

So please don't use those names on the forums to avoid confusion.
...
Word Context Cards and Simple Word Cards do help you learn Japanese,
but they shouldn't take most of your SRS time.

WCCs don't make a lot of sense to me personally, and I don't use them.
If I need context then I just put it on the front.
If not, I use **simple word cards**.
...
that serves to reduce memory interference - the hint field.
Always providing context is a simpler and better solution in my opinion.

## Targeted sentence cards, or mpvacious cards

TSCs are like sentence cards, but you always make sure to highlight the target word.
I do it by selecting the word and pressing `Ctrl+B` in Anki, nice and simple.
I also have a few lines of basic CSS and JavaScript in my
...
on too much things at the same time. But you can go even further.
...
you can review TSCs much faster. But at the same time you always have access
to the full sentence on the front, so you can read it if you want, or skip reading if you
don't have time to spend on your reviews.
If you have a backlog, just drop the weight quickly and go back to the fun stuff.
...
You don't have to test yourself on every word, though you always have the option.
...
that I still knew poorly or didn't know at all.
...
but they might contain more than one unknown word total.
...
On the other hand, a TSC with many unknown words does not become a burden,
you skip everything but the main target.
* **Keep your cards.**
...
You also violate the `practice how you play`
principle by testing yourself on something that is rarely seen in real life.
...
But most of the time it happens after the first lookup,
and the knowledge transfers automatically from being context-dependent to context-independent.
...
you are able to do it up to 4 times faster.
...
or read the sentence once the back of the card is revealed, but it's totally optional.

For many years I studied with sentence cards,
and though I achieved great results,
...
And then there are targeted sentence cards.
